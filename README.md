...
- Twenty-three WebMCP tools connected to the same game state as the visual board
...
The complete WebMCP surface has 23 tools covering the academy, trophies, history and replay, every legal move, full game state, explanations, difficulty, playing either color, pause/resume, undo, resignation, agreed draws, saved games, custom FEN positions, camera views, and the local leaderboard.
